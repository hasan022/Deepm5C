...
"""
net = unitNET(features = 64, lstm_hidden_size = 175)
params_blstm = 0
for p in net.parameters():
    #print(p.size())
    if p.requires_grad:
        params_blstm += p.numel()  
...
net = unitNET(device, features = 7)
output_1, output_2, output_3 = net.forward(vec.float())

temp_1 = output_1.detach().numpy()
temp_2 = output_2.detach().numpy()
temp_3 = output_3.detach().numpy()
